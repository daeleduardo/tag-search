...
function fingerprint_cookie() {
    "use strict";
    let strOnError, bolCookieEnabled;
...
function fingerprint_fonts() {
    ...
    try {
        ...
        let style, fonts, count, template, fragment, divs, i, font, div, body, result, e;
...
function fingerprint_silverlight() {
    "use strict";
    let strOnError, objControl, objPlugin, strSilverlightVersion, strOut;
    ...
    try {
        try {
            ...
            } else if (objControl.IsVersionSupported("1.0")) {
...
function fingerprint_plugins() {
    ...
    try {
        ...
        htIEComponents.put('76C19B38-F0C8-11CF-87CC-0020AFEECF20', 'ArabicDS'); // Arabic Text Display Suppoart
